...
public class DocumentacionDelAPi {
	...
	public OpenAPI openApi() {
		return new OpenAPI().info(new Info().title("MIcroservicio de Gestion de Usuarios")
				.description("Microservicio Usuario").termsOfService("https://gizlocorp.com/").version("1.0.0")
